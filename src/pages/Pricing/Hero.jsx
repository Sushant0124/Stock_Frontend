        ...
        <div className='hero'>
            ...
            <div className='pricing-section'>
                <div className='pricing-card'>
                    <img src='/images/pricingEquity.svg' alt='Free equity delivery' className='pricing-image'/>
                ...
                <div className='pricing-card'>
                    <img src='/images/intradayTrades.svg' alt='Intraday and F&O trades' className='pricing-image'/>
                ...
                <div className='pricing-card'>
                    <img src='/images/pricingMF.svg' alt='Free direct MF' className='pricing-image'/>
